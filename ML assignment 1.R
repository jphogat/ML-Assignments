...
weight <- c(134,145,132)
weight
# replace and add values as appropriate
...
png(file="Quantitative variable.png")
...
# statistics for a qualitative variable/categorical 
PTable <- table(Tech_Sales_Reps$Personality)
PTable


# Calculate a summary measure of all variables in this file(Transformation)
summary(Tech_Sales_Reps$Salary)

# Plot the table
barplot(PTable)

# scatter Plot
input<-Tech_Sales_Reps[,c('Age','Salary')]
...
plot(x=input$Age, y=input$Salary,
     xlab="Age",
     ylab="Salary",
     xlim=c(20,65),
     ylim=c(20000,200000),
